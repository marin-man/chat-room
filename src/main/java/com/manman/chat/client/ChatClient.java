package com.manman.chat.client;

import com.manman.chat.message.*;
...
public class ChatClient {
    public static void main(String[] args) {
        ...
        CountDownLatch WAIT_FOR_LOGIN = new CountDownLatch(1);   // 判断登录是否响应
        AtomicBoolean LOGIN = new AtomicBoolean(false);  // 占位登录
        try {
